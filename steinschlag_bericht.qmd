...
| Geschwindigkeit | 2    | Weibul      | `r zone_2_velocity$estimate[1]` | `r zone_2_velocity$estimate[2]` |
...
| Zufallsvariable | Zone | Verteilung  | Parameter 1                     | Parameter 2                     |
|---------------|:--------------|---------------|---------------|---------------|
| Masse           | 1    | Weibul      | `r one.mass$estimate[1]`     | `r one.mass$estimate[2]`     |
...
| Geschwindigkeit | 2    | Weibul      | `r two.velocity$estimate[1]` | `r two.velocity$estimate[2]` |
